...
# Creates the solid_cable_messages table for Solid Cable (ActionCable adapter).
# Run before AddUniqueIndexToSolidCableMessagesId. Table uses default primary key (id).

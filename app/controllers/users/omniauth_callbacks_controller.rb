...
class Users::OmniauthCallbacksController < Devise::OmniauthCallbacksController
  def github
    ...
    new_oauth_registration = existing_user.blank?
    ...
    if user.persisted?
      sign_in user
      if new_oauth_registration
        redirect_to complete_profile_registration_path, notice: "GitHub account connected. Confirm your username and complete your profile (optional)."
      else
